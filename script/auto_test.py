...
parser.add_argument(
    "--world", type=str, default="_egoplanner_4uav_19obs_new", help="world name"
)
...
parser.add_argument(
    "--cmd_source",
    type=str,
    default="source /home/siyuan/workspace/dyn_env_ego-swarm/devel/setup.zsh",
)
parser.add_argument(
    "--cmd_recorder",
    type=str,
...
parser.add_argument(
    "--cmd_launch",
    type=str,
    default="roslaunch ego_planner dyn_evaluate.launch",
)

...
parser.add_argument(
    "--save_path", type=str, default="resultsneocld", help="folder name"
)
...
if __name__ == "__main__":
    ...
    launch_cmds = [
        ...
        # "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=50",
        # "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=40",
        # "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=30",
        # "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=20",
        # "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=10",
        # "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=50",
        # "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=40",
        # "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=30",
        # "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=20",
        # "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=10",
        ...
        "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=50 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=40 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=30 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=20 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_0.launch rviz:=false obs_num:=10 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=50 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=40 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=30 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=20 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_3.launch rviz:=false obs_num:=10 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_4.launch rviz:=false obs_num:=50 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_4.launch rviz:=false obs_num:=40 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_4.launch rviz:=false obs_num:=30 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_4.launch rviz:=false obs_num:=20 map_mode:=10",
        "roslaunch ego_planner sim_fkpcp_4_case_4.launch rviz:=false obs_num:=10 map_mode:=10",
    ]
    world_names = [
